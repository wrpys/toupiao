...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function toupiaoAdd(id, mingchengType)
           {
                 var strUrl="<%=path %>/admin/toupiao/toupiaoAdd.jsp?wenjuan_id="+id+"&mingchengType="+mingchengType;
           ...
           function wenjuanYulan0(id,type)
           {
        	   wenjuan_id = id;
	    	   mingchengType = type;
	    	   $("#dialog").dialog("open");
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						<c:if test="${wenjuan.mingchengType==1}">顺序</c:if>
						<c:if test="${wenjuan.mingchengType==2}">跳转</c:if>
					</td>
					<td bgcolor="#FFFFFF" align="center">
						${wenjuan.shijian}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						...
						<a style="color: red" href="#" onclick="wenjuanYulan0(${wenjuan.id}, ${wenjuan.mingchengType})">问卷预览</a>
